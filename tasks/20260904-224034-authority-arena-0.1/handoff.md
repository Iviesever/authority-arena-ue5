...
- Active phase: PACT-00/10/20/30/40/50 complete; PACT-60 full delivery verification begins next.
...
Write the packaged-build verifier RED, then build Development/Shipping, run all Automation, execute RunUAT BuildCookRun/Cook/Stage/Pak/IoStore/Archive, launch packaged output, run packaged two-client Combat, and repeat from a clean clone.
