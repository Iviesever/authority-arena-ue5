...
- Active phase: PACT-00/10/20/30/40 complete; PACT-50 C++ HUD and visual evidence begins next.
...
Write failing HUD view-model/reflection checks, then implement visible C++ Health/Energy/Cooldown/role/network/ability/death/score diagnostics and capture current-SHA two-client evidence.
